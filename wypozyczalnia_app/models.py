...
class Samochod(models.Model):
    ...
    czy_wynajety = models.DateTimeField(auto_now=False, auto_now_add=True, default= null, null= True) #może się wywalić tutaj
...
class Hulajnoga(models.Model):
    ...
    czy_wynajety = models.DateTimeField(auto_now=True, auto_now_add=False, default= null, null= True) #może się wywalić tutaj
